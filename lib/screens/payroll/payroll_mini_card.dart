...
class PayrollMiniCard extends StatefulWidget {
  const PayrollMiniCard({super.key});

  @override
  State<PayrollMiniCard> createState() => _PayrollMiniCardState();
}

class _PayrollMiniCardState extends State<PayrollMiniCard> {
